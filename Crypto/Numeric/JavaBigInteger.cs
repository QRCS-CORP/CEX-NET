...
//////
 ...
 /// -2<sup>{@code int.MaxValue}</sup> (exclusive) to
 /// +2<sup>{@code int.MaxValue}</sup> (exclusive)
...
{
    //extends Number implements Comparable<BigInteger> {
    //////
    ...
    //////
     ...
     /// range.
     ///
    private static int MAX_MAG_LENGTH = int.MaxValue / 4 + 1; // (1 << 26)

    //////
     /// Bit Lengths larger than this constant can cause overflow in searchLen
     /// calculation and in BitSieve.singleSearch method.
     ///
    private static  int PRIME_SEARCH_BIT_LENGTH_LIMIT = 500000000;
    ...
    //////
     ...
     ///
    private static int KARATSUBA_THRESHOLD = 80;
    ...
    //////
     ...
     ///
    private static int TOOM_COOK_THRESHOLD = 240;
    ...
    //////
     ...
     /// experimentally to work well.
     ///
    private static int KARATSUBA_SQUARE_THRESHOLD = 128;
    ...
    //////
     ...
     /// experimentally to work well.
     ///
    private static int TOOM_COOK_SQUARE_THRESHOLD = 216;
    ...
    //////
     ...
     ///
    static int BURNIKEL_ZIEGLER_THRESHOLD = 80;
    ...
    //////
     ...
     ///
    static int BURNIKEL_ZIEGLER_OFFSET = 40;
    ...
    //////
     ...
     ///
    private static int SCHOENHAGE_BASE_CONVERSION_THRESHOLD = 20;
    ...
    //////
     ...
     ///         BigInteger.
     /// @throws FormatException {@code val} is zero bytes long.
     ///
    ...
    //////
     ...
     ///         the number.
     /// @throws FormatException {@code signum} is not one of the three
    ...
    //////
     ...
     /// @throws FormatException {@code val} is not a valid representation
    ...
    public BigInteger(String val, int radix) 
    {
        ...
        if (radix < char.MinValue || radix > char.MaxValue)
        ...
        magnitude[numWords - 1] = int.Parse(group, radix);
        ...
        while (cursor < len) {
            ...
            groupVal = int.Parse(group, radix);
            if (groupVal < 0)
                throw new FormatException("Illegal digit");
    ...
    private int parseInt(char[] source, int start, int end) 
    {
        ...
        if (result == -1)
            throw new FormatException(new String(source));
    ...
    //////
     ...
     ///         BigInteger.
     /// @throws ArgumentException {@code numBits} is negative.
     /// @see #bitLength()
     ///
    ...
    private static int SMALL_PRIME_THRESHOLD = 95;
   ...
   //////
    ...
    private static double[] logCache;

    ////// The natural log of 2.  This is used in computing cache indices. ///
    private static double LOG_TWO = Math.Log(2.0);
    ...
    static BigInteger()
    {
        ...
        ///
         ...
         /// on demand.
         ///
        powerCache = new BigInteger[char.MaxValue+1][];
        logCache = new double[char.MaxValue+1];
    ...
    //////
     ...
     ///
    private static BigInteger NEGATIVE_ONE = valueOf(-1);
    ...
    private BigInteger getToomSlice(int lowerSize, int upperSize, int slice, int fullsize) 
    {
        ...
        // the sign is adjusted when the number is composed.
    ...
    public BigInteger modPow(BigInteger exponent, BigInteger m) 
    {
        ...
        BigInteger b = (this.signum < 0 || this.compareTo(m) >= 0
                           ? this.mod(m) : this);
        BigInteger result;
        if (m.testBit(0)) { // odd modulus
            result = b.oddModPow(exponent, m);
        } else {
            ///
            ...
            BigInteger a2 = b.modPow2(exponent, p);
    ...
    static int[] bnExpModThreshTable = {7, 25, 81, 241, 673, 1793, int.MaxValue}; // Sentinel
    ...
    ///
     ...
     ///
        ...
        // Allocate table for precomputed odd powers of b in Montgomery form
        ...
        int[] a = leftShift(b, b.Length, modLen << 5);
        ...
        // Fill in the table with odd powers of the b
    ...
    //////
     ...
     ///
    static int mulAdd(int[] nout, int[] nin, int offset, int len, int k) 
    {
        long kLong = k & LONG_MASK;
        long carry = 0;

        offset = nout.Length-offset - 1;
        for (int j=len-1; j >= 0; j--) {
            long product = (nin[j] & LONG_MASK) /// kLong +
                           (nout[offset] & LONG_MASK) + carry;
            nout[offset--] = (int)product;
            carry = product >> 32;
        }
        return (int)carry;
    }
    ...
    private BigInteger mod2(int p) 
    {
        ...
        Array.Copy(this.mag, (this.mag.Length - numInts), mag, 0, numInts);
    ...
    //////
     ...
     ///
    private int[] stripLeadingZeroInts(int[] val) 
    {
        int vlen = val.Length;
        int keep;
    ...
    // Support for resetting fields while deserializing
