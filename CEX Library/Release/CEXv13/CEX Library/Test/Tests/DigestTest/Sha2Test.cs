    ...
    public class Sha2Test : ITest
    {
        ...
        private static readonly byte[,][] _expected =
		{
            ...
            },
            {
                ...
                Hex.Decode("204a8fc6dda82f0a0ced7beb8e08a41657c16ef468b228a8279be331a703c33596fd15c13b1b07f9aa1d3bea57789ca031ad85c7a71dd70354ec631238ca3445"),
        ...
        private void DigestTest(IDigest Digest)
        {
            ...
            for (int i = 0; i < _input.Length; i++)
            {
                ...
                if (Compare.AreEqual(_expected[index, i], hash) == false)
                    throw new Exception("SHA2Vector: Expected hash is not equal! Expected: " + Hex.ToString(_expected[index, i]) + "Received: " + Hex.ToString(hash));
            }
        }
        #endregion
    }
