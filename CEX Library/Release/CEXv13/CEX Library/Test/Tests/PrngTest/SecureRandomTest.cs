    ...
    public class SecureRandomTest : ITest
    {
        ...
        private void RandomTest()
        {
            using (SecureRandom rnd = new SecureRandom())
            {
                ...
                for (int i = 0; i < 1000; i++)
                {
                    x4 = rnd.NextInt32(16777216, 3371);
                    if (x4 > 16777216)
                ...
                for (int i = 0; i < 1000; i++)
                {
                    x5 = rnd.NextUInt32(777216, 77721);
                    if (x5 > 777216)
                ...
                for (int i = 0; i < 1000; i++)
                {
                    x6 = rnd.NextInt64(281474976710653, 2814749767);
                ...
                for (int i = 0; i < 1000; i++)
                {
                    x7 = rnd.NextUInt64(72057594037927934, 5759403792);
