...
namespace VTDev.Projects.CEX.Crypto.Tests.BCiphers
{
    /**
    ...
    */
    public class Salsa20Engine
    {
        ...
        private readonly byte[] sigma = System.Text.Encoding.ASCII.GetBytes("expand 32-byte k");
        private readonly byte[] tau = System.Text.Encoding.ASCII.GetBytes("expand 16-byte k");
        /*
        ...
        */
        ...
        {
            if (Vector == null)
                throw new Exception("Init parameters must include an IV");

            if (Vector.Length != 8)
                throw new Exception("Requires exactly 8 bytes of IV");
