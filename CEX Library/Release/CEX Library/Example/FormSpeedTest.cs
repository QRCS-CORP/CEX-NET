...
using VTDev.Projects.CEX.Tests.SpeedTest;
...
namespace VTDev.Projects.CEX
{
    public partial class FormSpeedTest : Form
    {
        ...
        {  
            ...
            {"DCS: A dual AES CTR parallelized stream cipher", Engines.DCS},
            ...
            {"RSX: Rijndael using a Serpent key schedule", Engines.RSX},
        ...
        private void SetComboParams(Engines Engine)
        {
            ...
            switch (Engine)
            {
                ...
                case Engines.RHX:
                    ...
                    ComboEnumHelper.SetSelectedIndex(cbEngines, 4);
                ...
                case Engines.SHX:
                    ...
                    break;
                case Engines.SPX:
                    ComboEnumHelper.AddEnumRange(cbKeySize, typeof(KeySizes), 16, 64);
                    ComboEnumHelper.SetSelectedIndex(cbKeySize, 2);
                    cbRounds.Items.Add(RoundCounts.R32);
                    cbRounds.Items.Add(RoundCounts.R40);
                    cbRounds.Items.Add(RoundCounts.R48);
                    cbRounds.Items.Add(RoundCounts.R56);
