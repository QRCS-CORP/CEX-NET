...
namespace VTDev.Projects.CEX.Test.Tests.MacTest
{
    ...
    public class HMacTest : ITest
    {
        ...
        private static readonly byte[][] _keys =
		{
            ...
            // test case 5
			Hex.Decode("0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c"),
            // test case 6
            Hex.Decode("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" + 
		...
		{
			Hex.Decode("4869205468657265"),
			Hex.Decode("7768617420646f2079612077616e7420666f72206e6f7468696e673f"),
			Hex.Decode("dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd"),
            Hex.Decode("cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd"),
			Hex.Decode("546573742057697468205472756e636174696f6e"),
            Hex.Decode("54657374205573696e67204c6172676572205468616e20426c6f636b2d53697a65204b6579202d2048617368204b6579204669727374"),
			Hex.Decode("5468697320697320612074657374207573696e672061206c6172676572207468616e20626c6f636b2d73697a65206b657920616e642061206c61726765722074" + 
        ...
        private static readonly byte[][] _hashValue =
		{
            ...
            // 512 answer
			Hex.Decode("87aa7cdea5ef619d4ff0b4241a1d6cb02379f4e2ce4ec2787ad0b30545e17cdedaa833b7d6b8a702038b274eaea3f4e4be9d914eeb61f1702e696c203a126854"),

			Hex.Decode("5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843"),
            Hex.Decode("164b7a7bfcf819e2e395fbe73b56e0a387bd64222e831fd610270cd7ea2505549758bf75c05a994a6d034f65f8f0e6fdcaeab1a34d4a6b4b636e070a38bce737"),

			Hex.Decode("773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe"),
            Hex.Decode("fa73b0089d56a284efb0f0756c890be9b1b5dbdd8ee81a3655f83e33b2279d39bf3e848279a722c806b485a47e67c807b946a337bee8942674278859e13292fb"),

			Hex.Decode("82558a389a443c0ea4cc819899f2083a85f0faa3e578f8077a2e3ff46729665b"),
            Hex.Decode("b0ba465637458c6990e5a8c5f61d4af7e576d97ff94b872de76f8050361ee3dba91ca5c11aa25eb4d679275cc5788063a5f19741120c4f2de2adebeb10a298dd"),

			Hex.Decode("a3b6167473100ee06e0c796c2955552b"), //truncated
			Hex.Decode("415fad6271580a531d4179bc891d87a6"),

            Hex.Decode("60e431591ee0b67f0d8a26aacbf5b77f8e0bc6213728c5140546040f0ee37f54"),
            Hex.Decode("80b24263c7c1a3ebb71493c1dd7be8b49b46d1f41b4aeec1121b013783f8f3526b56d037e05f2598bd0fd2215d6a1e5295e64f73f63f0aec8b915a985d786598"),
        ...
        private void MacTest(byte[] Key, byte[] Input, byte[] Out256, byte[] Out512)
        {
            ...
            if (Out256.Length != 32) 
            {
                ...
                if (!Compare.AreEqual(Out256, trnHash))
                    throw new Exception("SHA256HMAC is not equal! Expected: " + Hex.ToString(Out256) + "Received: " + Hex.ToString(trnHash));
            }
            else
            {
                if (!Compare.AreEqual(Out256, hash))
                    throw new Exception("SHA256HMAC is not equal! Expected: " + Hex.ToString(Out256) + "Received: " + Hex.ToString(hash));
            }
            ...
            if (Out512.Length != 64)
            {
                ...
                if (!Compare.AreEqual(Out512, trnHash))
                    throw new Exception("SHA512HMAC is not equal! Expected: " + Hex.ToString(Out512) + "Received: " + Hex.ToString(trnHash));
            }
            else
            {
                if (!Compare.AreEqual(Out512, hash))
                    throw new Exception("SHA512HMAC is not equal! Expected: " + Hex.ToString(Out512) + "Received: " + Hex.ToString(hash));
            }
