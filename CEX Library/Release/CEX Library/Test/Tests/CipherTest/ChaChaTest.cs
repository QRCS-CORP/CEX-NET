...
namespace VTDev.Projects.CEX.Test.Tests
{
    ...
    public class ChaChaTest : ITest
    {
        ...
        private static readonly byte[][] _key = 
        {
            ...
            Hex.Decode("00400000000000000000000000000000"),
        ...
        {
            Hex.Decode("FBB87FBB8395E05DAA3B1D683C422046F913985C2AD9B23CFC06C1D8D04FF213D44A7A7CDB84929F915420A8A3DC58BF0F7ECB4B1F167BB1A5E6153FDAF4493D"),//20r-1
            Hex.Decode("A276339F99316A913885A0A4BE870F0691E72B00F1B3F2239F714FE81E88E00CBBE52B4EBBE1EA15894E29658C4CB145E6F89EE4ABB045A78514482CE75AFB7C"),//20r-2
            Hex.Decode("36CF0D56E9F7FBF287BC5460D95FBA94AA6CBF17D74E7C784DDCF7E0E882DDAE3B5A58243EF32B79A04575A8E2C2B73DC64A52AA15B9F88305A8F0CA0B5A1A25"),//12r
            Hex.Decode("BEB1E81E0F747E43EE51922B3E87FB38D0163907B4ED49336032AB78B67C24579FE28F751BD3703E51D876C017FAA43589E63593E03355A7D57B2366F30047C5"),//8r
            Hex.Decode("57459975BC46799394788DE80B928387862985A269B9E8E77801DE9D874B3F51AC4610B9F9BEE8CF8CACD8B5AD0BF17D3DDF23FD7424887EB3F81405BD498CC3"),//20r-256k
            Hex.Decode("92A2508E2C4084567195F2A1005E552B4874EC0504A9CD5E4DAF739AB553D2E783D79C5BA11E0653BEBB5C116651302E8D381CB728CA627B0B246E83942A2B99")//20r-256k
        };
        #endregion
        ...
        private void VectorTest(int Rounds, byte[] Key, byte[] Vector, byte[] Input, byte[] Output)
        {
            ...
            using (ChaCha chacha = new ChaCha(Rounds))
            {
                ...
                if (Compare.AreEqual(outBytes, Output) == false)
                    throw new Exception("ChaChaVector: Encrypted arrays are not equal! Expected: " + Hex.ToString(Output) + "Received: " + Hex.ToString(outBytes));
            ...
            if (Compare.AreEqual(outBytes, Input) == false)
                throw new Exception("ChaChaVector: Decrypted arrays are not equal! Expected: " + Hex.ToString(Input) + "Received: " + Hex.ToString(outBytes));
        }
