...
namespace VTDev.Libraries.CEXEngine.Utility
{
    ...
    public sealed class FileUtilities
    {
        ...
        public static string FileGetUniqueName(string FullPath)
        {
            ...
            if (!DirectoryUtilities.DirectoryExists(DirectoryUtilities.DirectoryGetPath(FullPath))) return string.Empty;

            string folderPath = DirectoryUtilities.DirectoryGetPath(FullPath);
        ...
        {
            if (DirectoryUtilities.DirectoryExists(DirectoryUtilities.DirectoryGetPath(FilePath)))
