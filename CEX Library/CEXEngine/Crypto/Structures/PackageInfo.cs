...
{
    /// <summary>
    /// A structure containing information about a <see cref="KeyPackage"/> file
    /// </summary>
    [Serializable]
    ...
    public struct PackageInfo
    {
        ...
        #region Constructor
        /// <summary>
        /// Build the PackageInfo structure from a <see cref="KeyPackage"/> file
        /// </summary>
        /// 
        /// <param name="Package">Populated KeyPackage structure</param>
        public PackageInfo(KeyPackage Package)
        {
