...
namespace VTDev.Libraries.CEXEngine.Crypto.Cipher.Asymmetric.Encrypt.NTRU
{
    ...
    public static class NTRUParamSets
    {
        ...
        {
            if (DbReduceMultiplier > 1.0 || DbReduceMultiplier < 0.0 || IgfIncreaseMultiplier > 1.0 || IgfIncreaseMultiplier < 0.0 || MgfIncreaseMultiplier > 1.0 || MgfIncreaseMultiplier < 0.0)
