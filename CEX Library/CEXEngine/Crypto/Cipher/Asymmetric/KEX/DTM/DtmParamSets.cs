...
namespace VTDev.Libraries.CEXEngine.Crypto.Cipher.Asymmetric.KEX.DTM
{
    ...
    public static class DtmParamSets
    {
        ...
        // convention: first letter of asymmetric cipher and set/subset for both ciphers, than both symmetric ciphers first letter and type (1 for standard, 2 for extended)
        // X1 //
