...
namespace VTDev.Projects.CEX.Test.Tests.SeedTest
{
    ...
    /// </summary>
    public class ISCRsgTest : ITest
    {
        #region Constants
        private const string DESCRIPTION = "ISCRsg Known Answer Test Vectors.";
        private const string FAILURE = "FAILURE! ";
        private const string SUCCESS = "SUCCESS! All ISCRsg tests have executed succesfully.";
        #endregion
        ...
        #region Vectors
        private static readonly uint[] _expected = 
        {
        ...
        public string Run()
        {
            ...
            {
                VectorTest();
                OnProgress(new TestEventArgs("Passed ISAAC vector tests.."));
        ...
        private void VectorTest()
        {
			...
			for (int i = 0; i < _expected.Length; i++)
			{
				...
				e = (int)_expected[i];
				if (x != e)
                    throw new Exception("ISCRsg: Values are not equal! Expected: " + e + " Received: " + x);
			}
        }
        #endregion
    }
